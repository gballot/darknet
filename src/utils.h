...
extern int *copy_int_array(size_t n, const int *a);
extern float *copy_float_array(size_t n, const float *a);
 ...
 */
extern int equals_int_array(size_t n, const int *a, const int *b);
