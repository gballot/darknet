#!/bin/sh
#SBATCH -o gpu-job-valgrind-fspt-waymo3.output
...
valgrind /home/gballot/NTU/FSPT\ Yolo/darknet/darknet -i 0 fspt train ${datacfg} ${netcfg} ${weightfile} ${options} -gpus 0
